...
public class AlipayConfig {
    ...
    public static String return_url = "http://kdvrjj.natappfree.cc/ShoesShop_war_exploded/aliPayReturnUrlServlet";  // 此处使用外网ip(使用免费的花生壳或者netapp产生的外网域名)
    // 服务器异步通知页面路径  需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
    public static String notify_url = "http://kdvrjj.natappfree.cc/ShoesShop_war_exploded/notify";
